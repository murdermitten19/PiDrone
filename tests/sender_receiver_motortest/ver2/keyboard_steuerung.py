...
def on_key_press(event):
    global motor_value1, motor_value2, motor_value3, motor_value4
    if event.keysym == 'w':
        motor_value1 = min(motor_value1 + 10, 253)
        motor_value2 = min(motor_value2 + 10, 253)


        motor_value3 = min(motor_value3 + 10, 253)
        motor_value4 = min(motor_value4 + 10, 253)
        ...
        motor_value1 = max(motor_value1 - 10, 0)
        motor_value2 = max(motor_value2 - 10, 0)


        motor_value3 = max(motor_value3 - 10, 0)
        motor_value4 = max(motor_value4 - 10, 0)
