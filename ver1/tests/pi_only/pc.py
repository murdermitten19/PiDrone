...
label6 = ttk.Label(root, text="100%")
label7 = ttk.Label(root, text="0%")


slider1 = ttk.Scale(root, from_=2, to=100, command=on_individual_slider_change1, orient=tk.HORIZONTAL)
slider2 = ttk.Scale(root, from_=2, to=100, command=on_individual_slider_change2, orient=tk.HORIZONTAL)
slider3 = ttk.Scale(root, from_=2, to=100, command=on_individual_slider_change3, orient=tk.HORIZONTAL)
slider4 = ttk.Scale(root, from_=2, to=100, command=on_individual_slider_change4, orient=tk.HORIZONTAL)
all_sliders = ttk.Scale(root, from_=2, to=100, command=on_all_sliders_change, orient=tk.HORIZONTAL)

button1 = ttk.Button(root, text="100%", command=on_button_press_100)
button2 = ttk.Button(root, text="0%", command=on_button_press_0)
